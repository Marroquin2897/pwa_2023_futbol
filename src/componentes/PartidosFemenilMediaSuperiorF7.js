...
const PartidosFemenilMediaSuperiorF7 = () => {
  ...
  return (
    <div className="hero">
      <nav>
        ...
        <center>
          <h2>Partidos Fútbol 7 Femenil Nivel Media Superior</h2>
        </center>
        <h3>
      ...
      <Helmet>
        <title>Partidos Fútbol 7 Femenil Nivel Media Superior</title>
      </Helmet>
      <main>
...
export default PartidosFemenilMediaSuperiorF7;
