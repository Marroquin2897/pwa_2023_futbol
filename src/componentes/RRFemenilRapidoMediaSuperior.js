        ...
        const fetchPartidos = async () => {
          try {
            ...
            const querySnapshot = await getDocs(
              query(partidosRef, where('jornada', '==', jornada), where('categoria', '==', 'Femenil'), where('nivelAcademico', '==', 'Media Superior'),where('modalidadTorneo', '==', 'Fútbol Rápido'))
            );
    ...
    return ( 
        <div className="hero">
            ...
            <img src="https://tinyurl.com/2obtocwe" alt=''/>
              <center><h2> Registro de Resultados Fútbol Rápido Femenil Nivel Media Superior</h2>
