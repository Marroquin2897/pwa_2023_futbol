...
const EstadisticasVaronilSuperiorFutAsociación = () => {
  const nameUsuario = sessionStorage.getItem("name")
    ...
    useEffect(() => {
        const fetchEstadisticasEquipos = async () => {
          try {
            const resultadosRef = collection(firestore, 'resultadosVaronilSuperiorAsociacion');
            ...
            equiposArray.forEach(async (equipo) => {
              const docRef = doc(firestore, 'tablaposicionesVaronilSuperiorFutAsociacion', equipo.equipo);
              const data = {
    ...
    return ( 
        <div className='hero'>
            ...
            <img src="https://tinyurl.com/2obtocwe"/>
              <center><h2> Tabla General de Posiciones Fútbol Asociación Varonil Nivel Superior </h2>
              <h2>{nameUsuario}</h2>
              </center> 
            <h3><img src="https://tinyurl.com/2kaldmbh"/></h3>
            </nav>
            <Helmet>
                <title> Tabla General de Posiciones Fútbol Asociación Varonil Nivel Superior</title>
            </Helmet>
...
export default EstadisticasVaronilSuperiorFutAsociación;