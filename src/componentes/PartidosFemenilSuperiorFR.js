...
const PartidosFemenilSuperiorFR = () => {
  ...
  return (
    <div className="hero">
      <nav>
        ...
        <center>
          <h2>Partidos Fútbol Rápido Femenil Nivel Superior</h2>
        </center>
        <h3>
      ...
      <Helmet>
        <title>Partidos Fútbol Rápido Femenil Nivel Superior</title>
      </Helmet>
      <main>
...
export default PartidosFemenilSuperiorFR;
