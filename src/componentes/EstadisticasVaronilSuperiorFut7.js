...
const EstadisticasVaronilSuperiorFut7 = () => {
    ...
    return (  
        <div className="hero">
            ...
            <Helmet>
                <title> Tabla General de Posiciones Fútbol 7 Varonil Nivel Superior</title>
            </Helmet>
            <div>
...
export default EstadisticasVaronilSuperiorFut7;