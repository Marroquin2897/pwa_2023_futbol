...
const PartidosVaronilMediaSuperiorFR = () => {
  ...
  return (
    <div className="hero">
      <nav>
        ...
        <center>
          <h2>Partidos Fútbol Rápido Varonil Nivel Superior</h2>
          <h3>{nameUsuario}</h3>
        </center>
        <h3>
      ...
      <Helmet>
        <title>Partidos Fútbol Rápido Varonil Nivel Superior</title>
      </Helmet>
      <main>
...
export default PartidosVaronilMediaSuperiorFR;
