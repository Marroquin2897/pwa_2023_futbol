...
const RRVaronilMediaSuperiorFut7 = () => {
    ...
    useEffect(() => {
        const fetchPartidos = async () => {
          try {
            ...
            const querySnapshot = await getDocs(
              query(partidosRef, where('jornada', '==', jornada), where('categoria', '==', 'Varonil'), where('nivelAcademico', '==', 'Media Superior'),where('modalidadTorneo', '==', 'Fútbol 7'))
            );
      ...
      const guardarResultados = () => {
        ...
        Object.entries(resultados).forEach(([partidoId, resultado]) => {
          ...
          const docRef = doc(
            firestore,
            'resultadosVaronilMediaSuperiorFut7',
    ...
    return ( 
        <div className='hero'>
            ...
            <Helmet>
                <title> Registro de Resultados Fútbol 7 Varonil Nivel Media Superior</title>
            </Helmet>
            <main>
            <div>
...
export default RRVaronilMediaSuperiorFut7;