...
const EstadisticasFemenilMediaSuperiorFut7 = () => {
    ...
    useEffect(() => {
        const fetchEstadisticasEquipos = async () => {
          try {
            const resultadosRef = collection(firestore, 'resultadosFemenilMediaSuperiorFut7');
            ...
            querySnapshot.forEach((doc) => {
              ...
              if (golesLocal > golesVisitante) {
                ...
                equiposArray.forEach(async (equipo) => {
                  const docRef = doc(firestore, 'tablaposicionesFemenilMediaSuperiorFut7', equipo.equipo);
                  const data = {
    ...
    return (  
        <div className="hero">
            ...
            <img src="https://tinyurl.com/2obtocwe"/>
              <center><h2> Tabla General de Posiciones Fútbol 7 Femenil Nivel Media Superior </h2><h2>{nameUsuario}</h2></center> 
            <h3><img src="https://tinyurl.com/2kaldmbh"/></h3>
            </nav>
            <Helmet>
                <title> Tabla General de Posiciones Fútbol 7 Femenil Nivel Media Superior</title>
            </Helmet>
            <div>
...
export default EstadisticasFemenilMediaSuperiorFut7;