...
const PartidosVaronilMediaSuperiorFA = () => {
  ...
  const obtenerPartidos = async () => {
    try {
      ...
      const q = query(partidosRef,
        ...
        where('modalidadTorneo', '==', 'Futbol Asociación'),
  ...
  return (
    <div className="hero">
      <nav>
        ...
        <center>
          <h2>Partidos Fútbol Asociación Varonil Nivel Media Superior</h2>
          <h3>{nameUsuario}</h3>
        </center>
        <h3>
      ...
      <Helmet>
        <title>Partidos Fútbol Asociación Varonil Nivel Media Superior</title>
      </Helmet>
      <main>
...
export default PartidosVaronilMediaSuperiorFA;
