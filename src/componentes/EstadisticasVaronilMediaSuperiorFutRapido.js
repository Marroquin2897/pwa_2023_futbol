...
const EstadisticasFemenilMediaSuperiorFutRapido = () => {
    ...
    useEffect(() => {
        const fetchEstadisticasEquipos = async () => {
          try {
            const resultadosRef = collection(firestore, 'resultadosVaronilMediaSuperiorRapido');
            ...
            querySnapshot.forEach((doc) => {
              ...
              if (golesLocal > golesVisitante) {
                ...
                equiposArray.forEach(async (equipo) => {
                  const docRef = doc(firestore, 'tablaposicionesFRVaronilMediaSuperior', equipo.equipo);
                  const data = {
    ...
    return (  
        <div className="hero">
            ...
            <img src="https://tinyurl.com/2obtocwe" alt=''/>
              <center><h2> Tabla General de Posiciones Fútbol Rápido Varonil Nivel Media Superior </h2><h2>{nameUsuario}</h2></center> 
            <h3><img src="https://tinyurl.com/2kaldmbh" alt=''/></h3>
            </nav>
            <Helmet>
                <title> Tabla General de Posiciones Fútbol Rápido Varonil Nivel Media Superior</title>
            </Helmet>
            <div>
