...
const PartidosVaronilSuperiorF7 = () => {
  ...
  return (
    <div className="hero">
      <nav>
        ...
        <center>
          <h2>Partidos Fútbol 7 Varonil Nivel Superior</h2>
        </center>
        <h3>
      ...
      <Helmet>
        <title>Partidos Fútbol 7 Varonil Nivel Superior</title>
      </Helmet>
      <main>
...
export default PartidosVaronilSuperiorF7;
